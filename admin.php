        ...
        <div class="row">
			...
			<div class="row">
				...
				if(isset($_POST["submit"]))
					{
						if($_POST["user"]=="group13"&&$_POST["pass"]=="group13")
						{
							 $_SESSION['usertype'] ='group13';
							 $_SESSION['username']='group13';
				...
				?>
					<form role="form" action="admin.php" method="post">
			    		...
			    		<button class="btn btn-primary pull-right" name="submit" type="submit"><i class="fa fa-sign-in"></i> <a href="http://localhost/phpmyadmin/db_structure.php?server=1&db=blood_bank" class="button">Login Here</a></button>
			      	</form>
				</div>
				<div class="col-md-3"></div>
			</div>
