					...
					<form autocomplete="off" method="post"  action="<?php echo $_SERVER['PHP_SELF'];?>" enctype="multipart/form-data">
						...
						<div class="form-group">
						 ...
						 <div class="form-group">
                                ...
                                <input type="text" required name="BUNIT" id="BUNIT" class="form-control" placeholder="Insert No Of Unit in ml">
                          </div>
						<div class="form-group">
						 ...
						 <div class="form-group">
                                ...
                                <input type="text" required name="CITY" id="CITY" class="form-control" placeholder="Type Your City">
                          </div>
						   <div class="form-group">
