...
?>
    ...
    <div class="container" style="margin-top:70px;">
            ...
            <div class="col-md-4">
                ...
                <p>
                    Blood Bank &amp; <br>This is a Website Created by Group 13. <br>
					Varad Potdar,Dhruv Totre<br>
					Aniket Patade,Pakshal Jain<br>
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr>:1234567891</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">Email At:</abbr>: <a href="#" >varad.potdar_19@sakec.ac.in</a>
                </p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">Email At</abbr>: <a href="#" >dhruv.totre_19@sakec.ac.in</a>
                </p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">Email At</abbr>: <a href="#" >aniket.patade_19@sakec.ac.in</a>
                </p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">Email At</abbr>: <a href="#" >pakshal.jain_19@sakec.ac.in</a>
                </p>
